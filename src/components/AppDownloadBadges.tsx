...
export const AppDownloadBadges: React.FC<AppDownloadBadgesProps> = ({
  ...
  return (
    <div
      className={`w-full ${
        isHero
          ? 'rounded-3xl bg-slate-900/40 backdrop-blur-xl border border-white/[0.08] p-5 shadow-lg shadow-black/10'
          : 'pt-2'
      }`}
    >
      {isHero && (
        <div className="flex items-center justify-between gap-3 mb-3.5">
          ...
          <span className="px-2.5 py-0.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-[10px] font-bold uppercase tracking-wider text-cyan-400">
            Próximamente
          </span>
        </div>
      )}
      ...
      >
        ...
        <a
          ...
          className="flex items-center justify-center gap-2.5 px-4 py-2.5 bg-slate-950/80 hover:bg-slate-900 border border-white/[0.1] hover:border-white/[0.2] rounded-2xl text-white shadow-sm transition-all duration-200 active:scale-95 group cursor-pointer"
          aria-label="Descargar en la App Store"
        >
          <svg className="w-4 h-4 fill-current flex-shrink-0 text-white" viewBox="0 0 170 170">
          ...
          <div className="text-left leading-none">
            ...
            <span className="text-xs font-bold tracking-tight text-white">App Store</span>
          </div>
        </a>
        ...
        >
          ...
          <div className="text-left leading-none">
            ...
            <span className="text-xs font-bold tracking-tight text-white">Google Play</span>
          </div>
        </a>
      </div>
    </div>
